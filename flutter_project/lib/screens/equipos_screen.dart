...
class _EquiposScreenState extends State<EquiposScreen> {
  ...
  Widget build(BuildContext context) {
    final activeCount =
        _devices.where((d) => d.status == DeviceStatus.operativo).length;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Salón 317 · Equipos',
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xFF161A33).withValues(alpha: 0.7),
                ...
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text('Salón ${widget.roomId}',
                            style: const TextStyle(
                                fontSize: 22,
                                fontWeight: FontWeight.bold,
                                color: Color(0xFFDEE0FF))),
                        const Text('Capacidad: 30 Equipos · Vista Planta',
                            style: TextStyle(
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              const Color(0xFF14BF59).withValues(alpha: 0.15),
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                              color: const Color(0xFF4AE176)
                                  .withValues(alpha: 0.3)),
                        ),
                        child: Text('$activeCount Activos OK',
                            style: const TextStyle(
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text('$faultCount Con Falla CRIT',
                            style: const TextStyle(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isFalla
                        ? const Color(0xFF93000A).withValues(alpha: 0.4)
                        : const Color(0xFF1A1E37).withValues(alpha: 0.8),
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(
                        color: isFalla
                            ? const Color(0xFFFFB4AB).withValues(alpha: 0.5)
                            : Colors.white10),
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(isFalla ? dev.issueDescription! : dev.subId,
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: const TextStyle(
                                  fontSize: 10, color: Color(0xFFBCC9CD))),
                        ],
                      ),
                    ],
                  ),
          ...
          ElevatedButton.icon(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (ctx) => const NuevoIncidenteScreen()),
              );
            },
            icon: const Icon(Icons.add_alert, color: Color(0xFF003640)),
            label: const Text('+ Reportar falla en este salón',
                style: TextStyle(
